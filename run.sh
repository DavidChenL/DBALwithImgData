...
CUDA_VISIBLE_DEVICES=2,3 python3 main.py --batch_size 128 --epochs 50 --lr 1e-3 --seed 369 --experiments 3 --dropout_iter 100 --init_size 200 --query 200 --acq_func 0 --val_size 1000 --model resnet18 --result_dir $log_dir --dataset CIFAR10 >> $log_file
